...
class RestReportData(BaseModel):
    """
    RestReportData
    """ # noqa: E501
    campaign_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the campaign", alias="campaignId")
    link_stats: Optional[List[LinkStat]] = Field(default=None, alias="linkStats")
    clicked_unique_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of unique contacts who clicked on the link", alias="clickedUniqueContactCount")
    opened_unique_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of unique contacts who opened the link", alias="openedUniqueContactCount")
    sent_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who sent the link", alias="sentContactCount")
    unsubscribe_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who unsubscribed from the link", alias="unsubscribeContactCount")
    bounce_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who bounced the link", alias="bounceContactCount")
    spam_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who marked the link as spam", alias="spamContactCount")
    clicked_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who clicked on the link", alias="clickedContactCount")
    opened_contact_count: Optional[StrictInt] = Field(default=None, description="Total number of contacts who opened the link", alias="openedContactCount")
    __properties: ClassVar[List[str]] = ["campaignId", "linkStats", "clickedUniqueContactCount", "openedUniqueContactCount", "sentContactCount", "unsubscribeContactCount", "bounceContactCount", "spamContactCount", "clickedContactCount", "openedContactCount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in link_stats (list)
        _items = []
        if self.link_stats:
            for _item_link_stats in self.link_stats:
                if _item_link_stats:
                    _items.append(_item_link_stats.to_dict())
            _dict['linkStats'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkStats": [LinkStat.from_dict(_item) for _item in obj["linkStats"]] if obj.get("linkStats") is not None else None,
