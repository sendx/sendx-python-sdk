...
class RestRTag(BaseModel):
    """
    RestRTag
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique tag identifier with tag_ prefix")
    name: Optional[StrictStr] = Field(default=None, description="Tag name")
    created: Optional[datetime] = Field(default=None, description="Tag creation timestamp")
    updated: Optional[datetime] = Field(default=None, description="Tag last update timestamp")
    __properties: ClassVar[List[str]] = ["id", "name", "created", "updated"]
    ...
    def id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^tag_[a-zA-Z0-9]{22}$", value):
            raise ValueError(r"must validate the regular expression /^tag_[a-zA-Z0-9]{22}$/")
        return value
