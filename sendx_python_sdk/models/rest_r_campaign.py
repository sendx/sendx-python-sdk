...
class RestRCampaign(BaseModel):
    """
    RestRCampaign
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Encrypted ID of the campaign")
    name: StrictStr = Field(description="Internal campaign name")
    subject: StrictStr = Field(description="Email subject line")
    preheader: Optional[StrictStr] = Field(default=None, description="Email preview text")
    sender: StrictStr = Field(description="Sender id")
    html_content: Optional[StrictStr] = Field(default=None, description="HTML email content", alias="htmlContent")
    text_content: Optional[StrictStr] = Field(default=None, description="Plain text email content", alias="textContent")
    schedule_type: StrictInt = Field(description="Campaign scheduling type.  **Values:** - `0` - Schedule later - `1` - Send Now ", alias="scheduleType")
    schedule_condition: StrictStr = Field(description="datetime for scheduled campaigns (required if scheduleType=1)", alias="scheduleCondition")
    ...
    timezone: Optional[StrictStr] = Field(default=None, description="Campaign timezone")
    smart_send: Optional[StrictBool] = Field(default=None, description="Timezone for the scheduled send", alias="smartSend")
    ...
    preferred_time_condition: Optional[StrictStr] = Field(default=None, description="Preferred time condition, in case of smartSend and sendInContactTimeZone", alias="preferredTimeCondition")
    preferred_timezone: Optional[StrictStr] = Field(default=None, description="Preferred timezone for smart send optimization", alias="preferredTimezone")
    strategy: Optional[StrictStr] = Field(default=None, description="Campaign delivery strategy")
    included_segments: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="Included segment IDs", alias="includedSegments")
    included_lists: List[Annotated[str, Field(strict=True)]] = Field(description="Included list IDs with prefix", alias="includedLists")
    included_tags: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="Included tag IDs with prefix", alias="includedTags")
    excluded_segments: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="Excluded segment IDs", alias="excludedSegments")
    excluded_lists: List[Annotated[str, Field(strict=True)]] = Field(description="Excluded list IDs with prefix", alias="excludedLists")
    excluded_tags: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="Excluded tag IDs with prefix", alias="excludedTags")
    created: Optional[datetime] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "subject", "preheader", "sender", "htmlContent", "textContent", "scheduleType", "scheduleCondition", "timeCondition", "timezone", "smartSend", "sendInContactsTimezone", "preferredTimeCondition", "preferredTimezone", "strategy", "includedSegments", "includedLists", "includedTags", "excludedSegments", "excludedLists", "excludedTags", "created", "updated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scheduleType": obj.get("scheduleType") if obj.get("scheduleType") is not None else 0,
