...
class RestRSender(BaseModel):
    """
    RestRSender
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique sender identifier with sender_ prefix")
    name: Optional[StrictStr] = Field(default=None, description="Sender display name")
    email: Optional[StrictStr] = Field(default=None, description="Sender email address")
    is_whitelisted: Optional[StrictBool] = Field(default=None, description="Sender whitelist status", alias="isWhitelisted")
    __properties: ClassVar[List[str]] = ["id", "name", "email", "isWhitelisted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "email": obj.get("email"),
            "isWhitelisted": obj.get("isWhitelisted")
        })
        return _obj
