...
class XEmailResponse(BaseModel):
    """
    XEmailResponse
    """ # noqa: E501
    to: Optional[StrictStr] = Field(default=None, description="Recipient email address")
    submitted_at: Optional[StrictInt] = Field(default=None, description="Unix timestamp of submission", alias="submittedAt")
    message_id: Optional[StrictStr] = Field(default=None, description="Unique message identifier", alias="messageId")
    error_code: Optional[StrictInt] = Field(default=None, description="Error code (0 = success)", alias="errorCode")
    message: Optional[StrictStr] = Field(default=None, description="Status message")
    __properties: ClassVar[List[str]] = ["to", "submittedAt", "messageId", "errorCode", "message"]
