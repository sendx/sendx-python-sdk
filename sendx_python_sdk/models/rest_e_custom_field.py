...
class RestECustomField(BaseModel):
    """
    RestECustomField
    """ # noqa: E501
    name: StrictStr = Field(description="Custom field name (must be unique within team)")
    type: StrictInt = Field(description="Field data type.  **Values:** - `0` - Text (max 255 characters) - `1` - Number (integer or decimal) - `2` - Date (YYYY-MM-DD format) - `3` - Boolean (true/false) - `4` - Phone number (international format) ")
