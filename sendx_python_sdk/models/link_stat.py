...
class LinkStat(BaseModel):
    ...
    Link statistics
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The link clicked")
    count: Optional[StrictInt] = Field(default=None, description="Total number of times the link was clicked")
    __properties: ClassVar[List[str]] = ["url", "count"]
