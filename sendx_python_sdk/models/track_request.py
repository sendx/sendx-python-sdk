...
class TrackRequest(BaseModel):
    ...
    TrackRequest
    """ # noqa: E501
    add_tags: Optional[List[StrictStr]] = Field(default=None, description="Tags to add to contact", alias="addTags")
    remove_tags: Optional[List[StrictStr]] = Field(default=None, description="Tags to remove from contact", alias="removeTags")
    email: Optional[StrictStr] = Field(default=None, description="Email address of the contact")
    __properties: ClassVar[List[str]] = ["addTags", "removeTags", "email"]
