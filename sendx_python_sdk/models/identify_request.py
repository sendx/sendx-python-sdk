...
class IdentifyRequest(BaseModel):
    ...
    new_email: Optional[StrictStr] = Field(default=None, description="New email when updating existing contact", alias="newEmail")
    __properties: ClassVar[List[str]] = ["email", "firstName", "lastName", "company", "customFields", "tags", "newEmail"]
