...
class RestRList(BaseModel):
    """
    RestRList
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    type: Optional[StrictInt] = Field(default=None, description="List type.  **Values:** - `0` - Regular list (single opt-in) - `1` - Double opt-in list (requires email confirmation) ")
    created: Optional[datetime] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "created", "updated"]
