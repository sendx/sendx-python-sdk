...
class RestESender(BaseModel):
    """
    RestESender
    """ # noqa: E501
    name: StrictStr = Field(description="Sender display name")
    email: StrictStr = Field(description="Sender email address (must be verified)")
