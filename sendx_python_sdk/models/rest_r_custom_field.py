...
class RestRCustomField(BaseModel):
    """
    RestRCustomField
    """ # noqa: E501
    id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique field identifier with field_ prefix")
    name: Optional[StrictStr] = Field(default=None, description="Custom field name")
    type: Optional[StrictInt] = Field(default=None, description="Field data type.  **Values:** - `0` - Text (max 255 characters) - `1` - Number (integer or decimal) - `2` - Date (YYYY-MM-DD format) - `3` - Boolean (true/false) - `4` - Phone number (international format) ")
    description: Optional[StrictStr] = Field(default=None, description="Field description for documentation")
    ...
    def id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^custom_field_[a-zA-Z0-9]{22}$", value):
            raise ValueError(r"must validate the regular expression /^custom_field_[a-zA-Z0-9]{22}$/")
        return value
