...
class RestRWebhook(BaseModel):
    """
    RestRWebhook
    """ # noqa: E501
    id: Optional[StrictStr] = None
    url: Optional[StrictStr] = Field(default=None, description="Webhook endpoint URL")
    enabled: Optional[StrictBool] = Field(default=True, description="Whether webhook is enabled")
    unsubscribed: Optional[StrictBool] = Field(default=False, description="Trigger webhook when a contact unsubscribes")
    dropped: Optional[StrictBool] = Field(default=False, description="Trigger webhook when an email is dropped")
    bounced: Optional[StrictBool] = Field(default=False, description="Trigger webhook when an email bounces")
    marked_spam: Optional[StrictBool] = Field(default=False, description="Trigger webhook when an email is marked as spam", alias="markedSpam")
    clicked: Optional[StrictBool] = Field(default=False, description="Trigger webhook when a link in the email is clicked")
    opened: Optional[StrictBool] = Field(default=False, description="Trigger webhook when an email is opened")
    contact_created: Optional[StrictBool] = Field(default=False, description="Trigger webhook when a new contact is created", alias="contactCreated")
    __properties: ClassVar[List[str]] = ["id", "url", "enabled", "unsubscribed", "dropped", "bounced", "markedSpam", "clicked", "opened", "contactCreated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unsubscribed": obj.get("unsubscribed") if obj.get("unsubscribed") is not None else False,
            "dropped": obj.get("dropped") if obj.get("dropped") is not None else False,
            "bounced": obj.get("bounced") if obj.get("bounced") is not None else False,
            "markedSpam": obj.get("markedSpam") if obj.get("markedSpam") is not None else False,
            "clicked": obj.get("clicked") if obj.get("clicked") is not None else False,
            "opened": obj.get("opened") if obj.get("opened") is not None else False,
            "contactCreated": obj.get("contactCreated") if obj.get("contactCreated") is not None else False
        })
        return _obj
