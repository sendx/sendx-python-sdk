...
class RestRPostCategory(BaseModel):
    """
    RestRPostCategory
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Id for the post category")
    name: Optional[StrictStr] = Field(default=None, description="Name for the post category")
    created: Optional[datetime] = Field(default=None, description="Date and time when the post category was created")
    updated: Optional[datetime] = Field(default=None, description="Date and time when the post category was last updated")
