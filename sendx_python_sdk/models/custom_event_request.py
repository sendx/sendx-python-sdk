...
class CustomEventRequest(BaseModel):
    ...
    CustomEventRequest
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="This is the contact identifier. Contact id and email can be used interchangeably. ")
    name: StrictStr = Field(description="Event name")
    data: Optional[Dict[str, Any]] = Field(default=None, description="Event data")
    time: Optional[StrictInt] = Field(default=None, description="Unix timestamp (in seconds since January 1, 1970) representing when the event occurred.")
    __properties: ClassVar[List[str]] = ["identifier", "name", "data", "time"]
