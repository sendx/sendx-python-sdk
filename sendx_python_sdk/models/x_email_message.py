...
class XEmailMessage(BaseModel):
    ...
    template: Optional[StrictStr] = Field(default=None, description="Template identifier")
    __properties: ClassVar[List[str]] = ["from", "to", "replyTo", "subject", "htmlBody", "textBody", "headers", "template"]
