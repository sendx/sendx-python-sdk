...
class RestRPostTag(BaseModel):
    """
    RestRPostTag
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = Field(default=None, description="Tag name")
    created: Optional[datetime] = Field(default=None, description="Date and time when tag was created")
    updated: Optional[datetime] = Field(default=None, description="Date and time when tag was updated")
