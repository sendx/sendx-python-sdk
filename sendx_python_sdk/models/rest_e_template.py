...
class RestETemplate(BaseModel):
    ...
    text_content: Optional[StrictStr] = Field(default=None, description="Plain text content", alias="textContent")
    preheader: Optional[StrictStr] = Field(default=None, description="Preview text")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Template tags for organization")
    __properties: ClassVar[List[str]] = ["name", "subject", "htmlContent", "textContent", "preheader", "tags"]
