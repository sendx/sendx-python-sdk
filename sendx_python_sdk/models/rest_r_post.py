...
class RestRPost(BaseModel):
    """
    RestRPost
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    post_title: Optional[StrictStr] = Field(default=None, alias="postTitle")
    post_description: Optional[StrictStr] = Field(default=None, alias="postDescription")
    post_category: Optional[StrictStr] = Field(default=None, alias="postCategory")
    member: Optional[StrictStr] = None
    post_thumbnail: Optional[StrictStr] = Field(default=None, alias="postThumbnail")
    is_published: Optional[StrictBool] = Field(default=None, alias="isPublished")
    included_tags: Optional[List[StrictStr]] = Field(default=None, alias="includedTags")
    post_slug: Optional[StrictStr] = Field(default=None, alias="postSlug")
    status: Optional[StrictInt] = None
    page_title: Optional[StrictStr] = Field(default=None, alias="pageTitle")
    page_description: Optional[StrictStr] = Field(default=None, alias="pageDescription")
    page_keywords: Optional[StrictStr] = Field(default=None, alias="pageKeywords")
    social_title: Optional[StrictStr] = Field(default=None, alias="socialTitle")
    social_description: Optional[StrictStr] = Field(default=None, alias="socialDescription")
    social_image_url: Optional[StrictStr] = Field(default=None, alias="socialImageUrl")
    created: Optional[datetime] = None
    updated: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "name", "postTitle", "postDescription", "postCategory", "member", "postThumbnail", "isPublished", "includedTags", "postSlug", "status", "pageTitle", "pageDescription", "pageKeywords", "socialTitle", "socialDescription", "socialImageUrl", "created", "updated"]
