...
class RestEWebhook(BaseModel):
    """
    RestEWebhook
    """ # noqa: E501
    url: StrictStr = Field(description="Webhook endpoint URL")
    enabled: StrictBool = Field(description="Whether webhook is enabled")
    ...
    __properties: ClassVar[List[str]] = ["url", "enabled", "unsubscribed", "dropped", "bounced", "markedSpam", "clicked", "opened", "contactCreated"]
