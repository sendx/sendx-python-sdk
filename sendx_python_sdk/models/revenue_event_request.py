...
class RevenueEventRequest(BaseModel):
    ...
    RevenueEventRequest
    """ # noqa: E501
    identifier: StrictStr = Field(description="Unique identifier for the contact.")
    amount: Union[StrictFloat, StrictInt] = Field(description="Recognized revenue amount associated with the event.")
    currency: StrictStr = Field(description="Currency code (ISO 4217) for the revenue (e.g., 'USD', 'EUR', 'INR').")
    ...
    __properties: ClassVar[List[str]] = ["identifier", "amount", "currency", "source", "time"]
