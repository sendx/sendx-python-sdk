...
class EmailSendingApi:
    ...
    def send_email(
        ...
        :param x_email_message: (required)
        :type x_email_message: XEmailMessage
        ...
        _param = self._send_email_serialize(
            x_email_message=x_email_message,
    ...
    def send_email_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[XEmailResponse]]:
        """Send transactional email
    ...
    def _send_email_serialize(
        ...
        if x_email_message is not None:
            _body_params = x_email_message
    ...
    def send_email_with_template(
        self,
        template_email_message: TemplateEmailMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param template_email_message: (required)
        :type template_email_message: TemplateEmailMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_email_with_template_serialize(
            template_email_message=template_email_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _send_email_with_template_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if template_email_message is not None:
            _body_params = template_email_message
