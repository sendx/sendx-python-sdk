...
class PostApi:
    ...
    def create_post(
        ...
        :param rest_e_post: (required)
        :type rest_e_post: RestEPost
    ...
    def _create_post_serialize(
        ...
        if rest_e_post is not None:
            _body_params = rest_e_post
    ...
    def get_all_posts(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Number of posts to skip")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="Maximum number of posts to return")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
