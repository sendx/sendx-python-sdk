...
class TeamMemberApi:
    ...
    def get_all_team_members(
        ...
        _param = self._get_all_team_members_serialize(
    ...
    @validate_call
    def get_all_team_members_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_all_team_members_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_team_members_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def _get_team_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/team/member/{identifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
