...
class PostTagApi:
    ...
    def create_post_tag(
        ...
        :param rest_e_post_tag: (required)
        :type rest_e_post_tag: RestEPostTag
        ...
        _param = self._create_post_tag_serialize(
            rest_e_post_tag=rest_e_post_tag,
    ...
    @validate_call
    def create_post_tag_with_http_info(
        self,
        rest_e_post_tag: RestEPostTag,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_post_tag_without_preload_content(
        self,
        rest_e_post_tag: RestEPostTag,
        _request_timeout: Union[
            None,
    ...
    def _create_post_tag_serialize(
        self,
        rest_e_post_tag,
        _request_auth,
        _content_type,
        ...
        if rest_e_post_tag is not None:
            _body_params = rest_e_post_tag
    ...
    def delete_post_tag(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param identifier: The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv`  (required)
        :type identifier: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._delete_post_tag_serialize(
    ...
    @validate_call
    def delete_post_tag_with_http_info(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_post_tag_without_preload_content(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        _request_timeout: Union[
            None,
    ...
    def _delete_post_tag_serialize(
        self,
        identifier,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/post/tag/{identifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_post_tags(
        ...
        _param = self._get_all_post_tags_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_all_post_tags_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_all_post_tags_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_post_tags_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_post_tag(
        ...
        _param = self._get_post_tag_serialize(
            identifier=identifier,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_post_tag_with_http_info(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_post_tag_without_preload_content(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        _request_timeout: Union[
            None,
    ...
    def update_post_tag(
        ...
        _param = self._update_post_tag_serialize(
            identifier=identifier,
            rest_e_post_tag=rest_e_post_tag,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_post_tag_with_http_info(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        rest_e_post_tag: RestEPostTag,
        _request_timeout: Union[
    ...
    @validate_call
    def update_post_tag_without_preload_content(
        self,
        identifier: Annotated[str, Field(strict=True, description="The unique post tag identifier to retrieve. - `post_tag_leBDiFdrUnRmRz4nfopSrv` ")],
        rest_e_post_tag: RestEPostTag,
        _request_timeout: Union[
    ...
    def _update_post_tag_serialize(
        self,
        identifier,
        rest_e_post_tag,
        _request_auth,
