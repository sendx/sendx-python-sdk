...
from sendx_python_sdk.api_response import ApiResponse, T as ApiResponseT
import sendx_python_sdk.models
from sendx_python_sdk import rest
from sendx_python_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sendx_python_sdk.models, klass)
