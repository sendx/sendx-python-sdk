...
class TestRestEPostCategory(unittest.TestCase):
    """RestEPostCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestEPostCategory:
        """Test RestEPostCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestEPostCategory`
        """
        model = RestEPostCategory()
        if include_optional:
            return RestEPostCategory(
    ...
    def testRestEPostCategory(self):
        """Test RestEPostCategory"""
