...
class TestRestEWebhook(unittest.TestCase):
    """RestEWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestEWebhook:
        """Test RestEWebhook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestEWebhook`
        """
        model = RestEWebhook()
        if include_optional:
            return RestEWebhook(
