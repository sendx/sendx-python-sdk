...
class TestLinkStat(unittest.TestCase):
    """LinkStat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkStat:
        """Test LinkStat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkStat`
        """
        model = LinkStat()
        if include_optional:
            return LinkStat(
