...
class TestRestRSender(unittest.TestCase):
    """RestRSender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRSender:
        """Test RestRSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRSender`
        """
        model = RestRSender()
        if include_optional:
            return RestRSender(
