...
class TestXEmailResponse(unittest.TestCase):
    """XEmailResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XEmailResponse:
        """Test XEmailResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XEmailResponse`
        """
        model = XEmailResponse()
        if include_optional:
