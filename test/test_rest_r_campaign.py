...
class TestRestRCampaign(unittest.TestCase):
    """RestRCampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRCampaign:
        """Test RestRCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRCampaign`
        """
        model = RestRCampaign()
        if include_optional:
            return RestRCampaign(
                ...
                html_content = '',
                text_content = '',
                schedule_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                schedule_type = 0,
