...
class TestXAttachment(unittest.TestCase):
    """XAttachment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XAttachment:
        """Test XAttachment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XAttachment`
        """
        model = XAttachment()
        if include_optional:
            return XAttachment(
