...
class TestPostbackResponse(unittest.TestCase):
    """PostbackResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostbackResponse:
        """Test PostbackResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostbackResponse`
        """
        model = PostbackResponse()
        if include_optional:
