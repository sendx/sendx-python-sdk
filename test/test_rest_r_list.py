...
class TestRestRList(unittest.TestCase):
    """RestRList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRList:
        """Test RestRList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRList`
        """
        model = RestRList()
        if include_optional:
            return RestRList(
