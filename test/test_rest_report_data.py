...
class TestRestReportData(unittest.TestCase):
    """RestReportData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestReportData:
        """Test RestReportData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestReportData`
        """
        model = RestReportData()
        if include_optional:
            return RestReportData(
                campaign_id = 'campaign_6h8DnYrHt4KktCnG8PDO5Z',
                link_stats = [
                    {url=https://sendx.io, count=10}
                    ],
