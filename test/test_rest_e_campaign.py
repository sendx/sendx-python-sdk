...
class TestRestECampaign(unittest.TestCase):
    """RestECampaign unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestECampaign:
        """Test RestECampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestECampaign`
        """
        model = RestECampaign()
        if include_optional:
            return RestECampaign(
