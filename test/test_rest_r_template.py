...
class TestRestRTemplate(unittest.TestCase):
    """RestRTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRTemplate:
        """Test RestRTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRTemplate`
        """
        model = RestRTemplate()
        if include_optional:
