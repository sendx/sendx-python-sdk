...
class TestRestRMember(unittest.TestCase):
    """RestRMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRMember:
        """Test RestRMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRMember`
        """
        model = RestRMember()
        if include_optional:
            return RestRMember(
