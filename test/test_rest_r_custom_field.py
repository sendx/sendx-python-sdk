...
class TestRestRCustomField(unittest.TestCase):
    """RestRCustomField unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRCustomField:
        """Test RestRCustomField
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRCustomField`
        """
        model = RestRCustomField()
        if include_optional:
