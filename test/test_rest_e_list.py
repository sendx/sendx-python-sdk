...
class TestRestEList(unittest.TestCase):
    """RestEList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestEList:
        """Test RestEList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestEList`
        """
        model = RestEList()
        if include_optional:
            return RestEList(
