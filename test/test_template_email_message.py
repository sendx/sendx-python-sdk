...
class TestTemplateEmailMessage(unittest.TestCase):
    """TemplateEmailMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateEmailMessage:
        """Test TemplateEmailMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateEmailMessage`
        """
        model = TemplateEmailMessage()
        if include_optional:
            return TemplateEmailMessage(
                ...
                template = 'template_...',
                template_id = 'template_f3lJvTEhSjKGVb5Lwc5SWS',
                variables = {
                    'key' : null
                    }
            )
    ...
    def testTemplateEmailMessage(self):
        """Test TemplateEmailMessage"""
