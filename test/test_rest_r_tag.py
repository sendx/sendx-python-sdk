...
class TestRestRTag(unittest.TestCase):
    """RestRTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRTag:
        """Test RestRTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRTag`
        """
        model = RestRTag()
        if include_optional:
            return RestRTag(
