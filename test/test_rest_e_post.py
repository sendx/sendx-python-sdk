...
class TestRestEPost(unittest.TestCase):
    """RestEPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestEPost:
        """Test RestEPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestEPost`
        """
        model = RestEPost()
        if include_optional:
            return RestEPost(
