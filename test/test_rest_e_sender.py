...
class TestRestESender(unittest.TestCase):
    """RestESender unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestESender:
        """Test RestESender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestESender`
        """
        model = RestESender()
        if include_optional:
            return RestESender(
