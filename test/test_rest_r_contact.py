...
class TestRestRContact(unittest.TestCase):
    """RestRContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRContact:
        """Test RestRContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRContact`
        """
        model = RestRContact()
        if include_optional:
            return RestRContact(
