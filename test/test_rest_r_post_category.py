...
class TestRestRPostCategory(unittest.TestCase):
    """RestRPostCategory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRPostCategory:
        """Test RestRPostCategory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRPostCategory`
        """
        model = RestRPostCategory()
        if include_optional:
    ...
    def testRestRPostCategory(self):
        """Test RestRPostCategory"""
