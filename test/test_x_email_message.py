...
class TestXEmailMessage(unittest.TestCase):
    """XEmailMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XEmailMessage:
        """Test XEmailMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XEmailMessage`
        """
        model = XEmailMessage()
        if include_optional:
            return XEmailMessage(
                var_from = sendx_python_sdk.models.x_from.XFrom(
                    email = 'from@example.com', 
                    name = 'From Name', ),
                to = [
                    sendx_python_sdk.models.xto.XTo(
                ...
                reply_to = sendx_python_sdk.models.x_reply_to.XReplyTo(
                    email = 'reply@example.com', 
                    name = 'Reply Name', ),
                subject = 'Your Subject Here',
                html_body = '<h1>Your HTML Content</h1>',
                text_body = 'Your Text Content',
                amp_body = '<!doctype html><html ⚡4email><head><meta charset="utf-8"><style amp4email-boilerplate>body{visibility:hidden}</style><script async src="https://cdn.ampproject.org/v0.js"></script></head><body>Hello, AMP world.</body></html>',
                attachments = [
                    sendx_python_sdk.models.x_attachment.XAttachment(
