...
class TestXReplyTo(unittest.TestCase):
    """XReplyTo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XReplyTo:
        """Test XReplyTo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XReplyTo`
        """
        model = XReplyTo()
        if include_optional:
            return XReplyTo(
