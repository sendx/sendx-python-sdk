...
class TestRestETemplate(unittest.TestCase):
    """RestETemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestETemplate:
        """Test RestETemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestETemplate`
        """
        model = RestETemplate()
        if include_optional:
