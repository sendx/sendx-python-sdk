...
class TestRestRWebhook(unittest.TestCase):
    """RestRWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRWebhook:
        """Test RestRWebhook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRWebhook`
        """
        model = RestRWebhook()
        if include_optional:
            return RestRWebhook(
