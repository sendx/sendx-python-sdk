...
class TestRestRPostTag(unittest.TestCase):
    """RestRPostTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRPostTag:
        """Test RestRPostTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRPostTag`
        """
        model = RestRPostTag()
        if include_optional:
            return RestRPostTag(
