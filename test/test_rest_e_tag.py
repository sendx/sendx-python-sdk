...
class TestRestETag(unittest.TestCase):
    """RestETag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestETag:
        """Test RestETag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestETag`
        """
        model = RestETag()
        if include_optional:
            return RestETag(
