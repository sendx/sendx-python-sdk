...
class TestPostTagApi(unittest.TestCase):
    """PostTagApi unit test stubs"""
    ...
    def test_create_post_tag(self) -> None:
        """Test case for create_post_tag

        Create post tag
        """
        pass

    def test_delete_post_tag(self) -> None:
        """Test case for delete_post_tag

        Delete post tag
        """
        pass

    def test_get_all_post_tags(self) -> None:
        """Test case for get_all_post_tags

        Get all post tags
        """
        pass

    def test_get_post_tag(self) -> None:
        """Test case for get_post_tag

        Get post tag by ID
        """
        pass

    def test_update_post_tag(self) -> None:
        """Test case for update_post_tag
