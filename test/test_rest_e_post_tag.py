...
class TestRestEPostTag(unittest.TestCase):
    """RestEPostTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestEPostTag:
        """Test RestEPostTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestEPostTag`
        """
        model = RestEPostTag()
        if include_optional:
            return RestEPostTag(
