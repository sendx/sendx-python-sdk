...
class TestRestRPost(unittest.TestCase):
    """RestRPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestRPost:
        """Test RestRPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestRPost`
        """
        model = RestRPost()
        if include_optional:
            return RestRPost(
